...
const Navbar = () => {
  ...
  return (
    <>
      {!isOpen && (
        <div
          className={`fixed w-full grid grid-cols-[15%_60%_25%] h-16 z-99 p-4 ${
        ...
        >
          ...
          <div className="flex items-center justify-center">
            <div className="flex items-center space-x-4">
              ...
              <span
                className={`w-px h-5 inline-block ${
                      ...
                      {menu.submenu?.map((sub, subIdx) => (
                        <li key={subIdx}>
                          <Link
                            to={sub.path}
                            onClick={closeMenu}
                            className={`block py-1 px-2 rounded transition-all duration-50 whitespace-nowrap ${
                              openMenu === menu.name
